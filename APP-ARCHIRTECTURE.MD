...
- (Add details if present: e.g., Jest, React Testing Library, E2E tests, CI setup)
- Test files are located in `__tests__` folders alongside code.

## 14. Future Improvements / TODOs

- (Add any known limitations, planned features, or technical debt to address)
